...
Once you have downloaded and installed Node, you need to install the Express, Angular, Mongoose, Body-Parser, Webpack, and Bootstrap via the command line.  First, be sure you are in the "susan_clprojects" folder and do an "ls". 
